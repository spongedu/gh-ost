...
#### GitHub's online schema migration for MySQL <img src="doc/images/gh-ost-logo-light-160.png" align="right">
 ...
 `gh-ost` is a triggerless online schema migration solution for MySQL. It is testable and provides pausibility, dynamic control/reconfiguration, auditing, and many operational perks.
